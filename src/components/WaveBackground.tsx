  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-[18%] -left-[18%] w-[150%] h-[150%] opacity-30 mix-blend-screen pointer-events-none"
        style={{
      ...
      <motion.div
        ...
        className="absolute -bottom-[18%] -right-[18%] w-[150%] h-[150%] opacity-25 mix-blend-screen pointer-events-none"
        style={{
