...
function getEmployeeImage(name: string, index: number) {
  ...
  const portraitList =
    femaleFirstNames.has(firstName)
      ? femalePortraits
      : malePortraits;
...
export function EmployeeScreen() {
  return (
    <motion.div
      ...
      className="pb-12 px-6 md:px-12 max-w-7xl mx-auto space-y-8"
    >
      ...
      <div className="flex flex-col md:flex-row gap-6 items-center pt-6 border-b border-white/50 pb-6 relative">
        ...
        <div className="space-y-4 text-center md:text-left flex-1">
          ...
          <motion.h1
            ...
            className="text-5xl lg:text-7xl font-bold text-white tracking-tight drop-shadow-sm"
          >
          ...
          <motion.p
            variants={cardVariants}
            className="text-lg text-slate-300 font-medium mt-2 max-w-xl"
          >
          ...
          <motion.div
            variants={cardVariants}
            className="text-3xl font-light text-slate-200 mt-4 inline-block"
          >
        ...
        {employees.map((emp, i) => (
          ...
          >
            ...
            <SpotlightCard
              ...
              p-6
              overflow-hidden
              shadow-[0_12px_30px_rgba(14,165,233,0.06)]
            ...
            >
              ...
              <div className="absolute right-6 top-6 h-24 w-24 rounded-full bg-sky-500/10 md:blur-3xl blur-xl" />

              <div className="absolute left-6 bottom-6 h-32 w-32 rounded-full bg-sky-400/10 md:blur-3xl blur-xl" />

              <div className="relative z-10 flex flex-col h-full">

                <div className="mb-6 flex gap-4 items-center border-b border-white/10 pb-4">

                  <div className="relative z-10 inline-flex items-center justify-center w-16 h-16 rounded-[1.5rem] bg-slate-900/90 border border-sky-400/20 overflow-hidden">
                    ...
                    <img
                      ...
                      onError={(event) => {
                        ...
                        target.src =
                          `https://api.dicebear.com/7.x/notionists/svg?seed=${encodeURIComponent(emp.name)}`;
                      }}
                    />
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-xl md:text-2xl font-semibold text-white group-hover:text-sky-300 transition-colors">

                      {emp.name}

                    </h3>

                    <div className="text-xs uppercase tracking-[0.24em] text-sky-200/70 mt-2">
                ...
                <div className="grid gap-4 flex-1">
                  ...
                  <div className="rounded-[1.75rem] border border-white/10 bg-slate-900/80 p-4 shadow-inner">

                    <div className="text-xs uppercase tracking-[0.24em] text-sky-200/70 mb-2">
                    ...
                    <div className="text-sm text-slate-300 flex items-start gap-2 mt-2">
                  ...
                  <div className="rounded-[1.75rem] border border-white/10 bg-slate-900/80 p-4 shadow-inner">
                    ...
                    <div className="text-sm text-slate-300 leading-relaxed mt-3">

                      {emp.bloodGroup
                        ? `Blood Group: ${emp.bloodGroup}`
                        : 'Core talent and team-first mindset.'}
